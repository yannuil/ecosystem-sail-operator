...
type IstioSpec struct {
	...
	// Must be one of: v1.26-latest, v1.26.1, v1.24-latest, v1.24.6, v1.24.5, v1.24.4, v1.24.3.
	// +operator-sdk:csv:customresourcedefinitions:type=spec,order=1,displayName="Istio Version",xDescriptors={"urn:alm:descriptor:com.tectonic.ui:fieldGroup:General", "urn:alm:descriptor:com.tectonic.ui:select:v1.26-latest", "urn:alm:descriptor:com.tectonic.ui:select:v1.26.1", "urn:alm:descriptor:com.tectonic.ui:select:v1.24-latest", "urn:alm:descriptor:com.tectonic.ui:select:v1.24.6", "urn:alm:descriptor:com.tectonic.ui:select:v1.24.5", "urn:alm:descriptor:com.tectonic.ui:select:v1.24.4", "urn:alm:descriptor:com.tectonic.ui:select:v1.24.3"}
	// +kubebuilder:validation:Enum=v1.26-latest;v1.26.1;v1.24-latest;v1.24.6;v1.24.5;v1.24.4;v1.24.3
	// +kubebuilder:default=v1.26.1
...
type Istio struct {
	...
	// +kubebuilder:default={version: "v1.26.1", namespace: "istio-system", updateStrategy: {type:"InPlace"}}
	// +optional
